...
/*Query 3 - provide a table with the family-friendly film category, each of the quartiles,
...
/*Query 4 - Can you write a query to capture the customer name, 
month and year of payment, and total payment amount for each month by 
